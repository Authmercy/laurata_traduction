                ...
                <div className="flex flex-col justify-center gap-4 text-2xl">
                  <Link href="/students/metier/fichesMetier">
                    <div className="flex items-center gap-2 py-2">
                      ...
                      <p className="text-[#4A62AA] font-bold  hover:text-[#A87A38]">Fiches métiers</p>
                    </div>
                  </Link>
                  <Link href="/students/metier/metierSansFormation">
                    <div className="flex items-center gap-2 py-2">
                      <img src="/icons/puces_1.png" alt="" className="w-5" />
                      <p className="text-[#4A62AA] font-bold  hover:text-[#A87A38]">Métiers sans offres de formation</p>
                    </div>
                  </Link>
                  <Link href="/students/metier/metierSansDebouche">
                    <div className="flex items-center gap-2 py-2">
                      <img src="/icons/puces_1.png" alt="" className="w-5" />
                      <p className="text-[#4A62AA] font-bold  hover:text-[#A87A38]">Métiers sans débouchés</p>
                    </div>
                  </Link>
                  ...
                  <Link href="/students/metier/metierPorteur">
                    <div className="flex items-center gap-2 py-2">
                      <img src="/icons/puces_1.png" alt="" className="w-5" />
                      <p className="text-[#4A62AA] font-bold  hover:text-[#A87A38]">Métiers porteurs</p>
                    </div>
                  </Link>
                </div>
              </div>
