  ...
  return (
    <div className="flex flex-wrap pl-10 pt-8">
      <div className="flex-grow md:w-2/3  text-black  p-8">
        <div className="  bg-[#A87A38]  p-3 text-center font-bold uppercase text-2xl text-white ">  Déposer mon cv</div>
        ...
        <div className="flex flex-row mt-4 gap-1">
          <div className="flex-4 bg-white/70 text-center font-bold text-[#4A62AA] py-8 px-4">
            Deux alternatives <br /> pour envoyer votre CV</div>
          <div className="flex-1 bg-white/70 pl-24 h-28 mt-2 mb-2  text-black p-6 ">
            <p>1. Au format PDF à <span className="text-[#4A62AA] font-semibold">cv@laurata.com</span> en précisant vos domaines d'intéret. <br /> </p>
            <p className=" mt-4"> 2. Remplir et envoyer le formulaire ci-dessous.</p>
