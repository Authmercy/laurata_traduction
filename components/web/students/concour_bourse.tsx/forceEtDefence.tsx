    ...
    return (
        ...
        <div className="flex flex-col   mt-1  ">
            ...
            <div>
                ...
                >
                    <span className=" font-bold text-lg">ADMINISTRATION PÉNITENTIAIRE</span>
            ...
            <div>
                ...
                >
                    <span className=" font-bold uppercase text-lg">Forces Armées - police - Gendarmerie</span>
                                            ...
                                            <tbody>
                                                {item.exam.map((exam) => (
                                                    <tr
                                                        ...
                                                        className="text-black border-b-2 border-[#c1c6d8]"
                                                    >
                                                        <td className="border border-x-0 text-center p-4">
                                                            {exam.id}
                                                        </td>
                                                        <td className="border border-x-0 p-4">
                                                            {exam.name}
                                                        </td>
                                                        <td className="border border-x-0 text-center p-4">
                                                            {exam.link ? (
            ...
            <div>
                ...
                >
                    <span className=" font-bold text-lg text-center">SAPEUR-POMPIERS</span>
