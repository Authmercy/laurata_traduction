...
const InstitutionsPublicTable = () => {
    ...
    <div className="w-full overflow-x-auto">
        <table className="border-collapse w-full text-start">
            ...
            <tbody>
                {concours.filter(item => item.category === "PUBLIC_INSTITUTIONS").length > 0 ? (
                    concours
                        .filter(item => item.category === "PUBLIC_INSTITUTIONS")
                        .map((item, index) => (
                            <tr
                                key={item.id}
                    ...
                    <tr>
                        <td className="text-center col-span-3 p-4 text-gray-500">
                            Aucun concours disponible pour les institutions publiques pour le moment.
                            <br />
                            No public institution exams available at the moment.
                        </td>
                    </tr>
                )}
            </tbody>
...
export default InstitutionsPublicTable;
