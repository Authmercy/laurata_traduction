                    ...
                    <table className="border-collapse w-full text-start">
                        <thead className="font-bold">
                            <tr>
                                ...
                                <th className="p-2  text-start border border-x-0 border-[#4A62AA] ">INSTITUTION</th>
                                <th className="p-2 text-start border border-x-0 border-[#4A62AA] ">VILLE</th>
                            </tr>
                        </thead>
                          {institutionsParticulier.map((item, index) => (
                        <tbody>

                            <tr
                                key={item.id}
                                className={`text-black border-b-2 text-start  border-[#9C824A] `}
                            >
...
export default PublicAStatutParticuler;
