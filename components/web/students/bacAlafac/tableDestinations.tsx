        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="bg-[#ebddc9]">
              <th
                className="border p-2 text-start  "
          ...
          <tbody>
            ...
            {data
              ...
              .map((item) => (
                <tr key={item.id} className="hover:bg-gray-50 ${index % 2 === 0 ? 'bg-gray-100' : ''}">
                  <td className="border p-2">{item.rank}</td>
                  <td className="border p-2 font-medium">{item.country}</td>
                  <td className="border p-2 text-center ">{item.year2014}</td>
                  <td className="border p-2 text-center ">{item.year2019}</td>
                  <td className="border p-2 text-center ">{item.percentage2019}</td>
            ...
            <tr className="bg-gray-100 font-bold">
              ...
              <td className="border p-2 text-center ">{formatNumber(totals.year2014)}</td>
              <td className="border p-2 text-center ">{formatNumber(totals.year2019)}</td>
              <td className="border p-2 text-center ">100%</td>
              <td className="border p-2 text-center ">
                {((totals.year2019 - totals.year2014) / totals.year2014 * 100).toFixed(0)}%
              </td>
            </tr>
          </tbody>
        </table>
