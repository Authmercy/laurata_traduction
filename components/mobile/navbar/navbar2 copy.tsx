...
export default function Navbar3({ isMobileMenuOpen, setIsMobileMenuOpen, isMobileMenuOpen2, setIsMobileMenuOpen2 }: NavbarMobileProps) {
    ...
    <div>
      <div className="flex justify-between  text-sm items-center w-full px-4 py-4">
        ...
        <div className="justify-start flex items-start ">
          ...
          <Image
            src="/images/logolaurata.png"
            alt="logoSES"
            width={100}
            height={150}
            className="justify-start flex items-start "
          />   </div>
      ...
      {isMobileMenuOpen && (
        <div className=" w-full absolute top-24   text-[#1f386d] p-2 rounded z-50 bg-opacity-80">
          ...
          <div>
            ...
            >
              <Link href="/zoom" className="block px-2  hover:bg-gray-300">
                Zoom sur
              </Link>
            </button>
          ...
          <div>
            <button
              ...
              className="flex justify-between  text-lg items-center w-full text-left bg-gray-300 px-2 py-2 hover:text-neutral-950 transition  duration-200 "
            >
              <Link href="/actualite" className="block px-2  hover:bg-gray-300">
                Actualités
              </Link>
            </button>
          ...
          <div>
            <button
              ...
              className="flex justify-between  text-lg items-center w-full text-left bg-gray-300 px-2 py-2 hover:text-neutral-950 transition  duration-200 "
            >
              <Link href="/partners" className="block px-2  hover:bg-gray-300">
                Partenaires
              </Link>
            </button>
          ...
          <div>
            ...
            {openSubMenu === "autres" && (
              <div className=" bg-gray-300 p-2 pl-6 ">
                <Link href="/misc/presentaionDuSite" className="block px-2 py-1 hover:bg-white">
                  Présentation
                </Link>

                <Link href="/misc/legal" className="block px-2 py-1 hover:bg-gray-300">
                  Mentions Légales
                </Link>
                <Link href="/misc/cgu" className="block px-2 py-1 hover:bg-gray-300">
