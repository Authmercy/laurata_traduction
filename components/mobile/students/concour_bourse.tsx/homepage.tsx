...
export default function ConcourBourseMobile() {
             ...
             <div className="min-h-screen   bg-[#4A62AA]  overflow-auto  w-screen bg-cover  bg-center bg-no-repeat "  >
                ...
                <div className={`${isMobileMenuOpen ? "blur-sm " : ""
                    ...
                    <div className="justify-center p-2 text-center text-xl font-bold uppercase bg-[#9b6e0f] text-white">
                        <p>           CONCOURS & BOURSES </p>
                    </div>

                    <div className="bg-white/70 mt-8 uppercase  p-4 shadow-sm mb-2 hover:shadow-md transition-shadow">
                ...
                <div className="flex  mt-96 bg-white items-center justify-center  ">
