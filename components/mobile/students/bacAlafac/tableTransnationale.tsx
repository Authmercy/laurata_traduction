    ...
    {errorMessage}
         ...
         <table className="border-collapse w-full text-start">
                    <thead className="font-bold">
                        <tr>
                          <th className="p-2 text-center  border border-x-0 border-[#9C824A] ">INSTITUTION</th>
                            <th className="p-2 text-center border border-x-0 border-[#9C824A] ">LOGO</th>
                    ...
                    <tbody>
                            ...
                            <tr
                                key={item.id}
                                className={`text-black border-b-2  text-center border-[#4A62AA] `}
                            >
                                ...
                                <td>
                                    <img src={item.shortName} alt="logo" className='w-24 h-24' />
                                </td>
                                <td>
                                    {item.city}
                                </td>
