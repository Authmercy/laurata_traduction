"use client";
import FemmeDimpact from "@/components/web/femme d'impact/femme";
import Footer from "@/components/web/footer/footer";
import Bandeau from "@/components/web/Ads/FooterPartenaire";
import NavBarOffre from "@/components/web/navbar/navBarEtudiant";
import Sidebar from "@/components/web/sidebar/sideBar";
import FemmeDimpactMobile from "@/components/mobile/femme d'impact/femme";
    ...
    <div>
      <div className="flex flex-col min-h-screen">
        ...
        <div className="block lg:hidden">
          <FemmeDimpactMobile></FemmeDimpactMobile>
        </div>
