...
import DetailExperMobile from "@/components/mobile/parole_d_expert/detail";
import DetailExpert from "@/components/web/parole_d_expert/detail";
    ...
    <div>
      <div className="flex flex-col min-h-screen">
        ...
        <div className="block lg:hidden">
          <DetailExperMobile></DetailExperMobile>
          <BackToTopButton />
        </div>
