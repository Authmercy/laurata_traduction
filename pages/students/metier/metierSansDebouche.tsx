...
import MetierSansDeboucheComponent from "@/components/web/students/metier/metierSansDebouche";
import BackToTopButton from "@/components/buttonTop";
import MetierSansDeboucheComponentMobile from "@/components/mobile/students/metier/metierSansDebouche";
    ...
    <div>
      <div className="flex flex-col min-h-screen">
        <div className="hidden lg:flex flex-col flex-grow">
          <div className="relative flex flex-col min-w-screen min-h-screen h-auto w-auto  bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/images/backgroundEtudiant.jpeg')" }}>
            ...
            <div className="flex flex-row">
              <div className="w-[80%]">
                <MetierSansDeboucheComponent></MetierSansDeboucheComponent>
                <BackToTopButton />
              </div>
              <div className="w-[20%]">
                <Sidebar />
        ...
        <div className="block lg:hidden">
          <MetierSansDeboucheComponentMobile></MetierSansDeboucheComponentMobile>
          <BackToTopButton />
        </div>
