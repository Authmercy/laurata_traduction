...
import HandicapComponent from "@/components/web/students/bacAlafac/Handicap";
import BackToTopButton from "@/components/buttonTop";
import HandicapComponentMobile from "@/components/mobile/students/bacAlafac/Handicap";
  ...
  return (
    <div> <div className="flex flex-col min-h-screen">
      <div className="hidden lg:flex flex-col flex-grow">
        <div
          ...
          <div className="flex flex-row">
            <div className="w-[80%]">
              <HandicapComponent></HandicapComponent>
              <BackToTopButton />
            </div>
            <div className="w-[20%]">
              <Sidebar />
      ...
      <div className="block lg:hidden">
        <HandicapComponentMobile></HandicapComponentMobile>
        <BackToTopButton />
      </div>
    </div>
