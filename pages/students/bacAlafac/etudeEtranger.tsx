...
import EtudeComponent from "@/components/web/students/bacAlafac/etudeEtranger";
import BackToTopButton from "@/components/buttonTop";
import EtudeComponentMobile from "@/components/mobile/students/bacAlafac/etudeEtranger";
  ...
  return (
    <div> <div className="flex flex-col min-h-screen">
      ...
      <div className="block lg:hidden">
        <EtudeComponentMobile></EtudeComponentMobile>
        <BackToTopButton />
      </div>
    </div>
